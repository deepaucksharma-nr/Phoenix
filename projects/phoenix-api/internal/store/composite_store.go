...
func (s *CompositeStore) CreateExperiment(ctx context.Context, experiment *internalModels.Experiment) error {
	...
	// Convert []string to map[string]string for target hosts
	targetNodes := make(map[string]string)
	for i, host := range experiment.Config.TargetHosts {
		targetNodes[fmt.Sprintf("host%d", i)] = host
	}
...
func (s *CompositeStore) CreateDeployment(ctx context.Context, deployment *models.PipelineDeployment) error {
	return s.pipelineStore.CreateDeployment(ctx, deployment)
}

func (s *CompositeStore) GetDeployment(ctx context.Context, deploymentID string) (*models.PipelineDeployment, error) {
	return s.pipelineStore.GetDeployment(ctx, deploymentID)
}

func (s *CompositeStore) ListDeployments(ctx context.Context, req *models.ListDeploymentsRequest) ([]*models.PipelineDeployment, int, error) {
	return s.pipelineStore.ListDeployments(ctx, req)
}

func (s *CompositeStore) UpdateDeployment(ctx context.Context, deploymentID string, update *models.UpdateDeploymentRequest) error {
...
func (s *CompositeStore) UpdateDeploymentMetrics(ctx context.Context, deploymentID string, metrics *models.DeploymentMetrics) error {
	return s.pipelineStore.UpdateDeploymentMetrics(ctx, deploymentID, metrics)
}

// Task operations (TODO: Implement)
func (s *CompositeStore) CreateTask(ctx context.Context, task *internalModels.Task) error {
	// TODO: Implement task storage
	return nil
}

func (s *CompositeStore) GetTask(ctx context.Context, taskID string) (*internalModels.Task, error) {
	// TODO: Implement
	return nil, fmt.Errorf("not implemented")
}

func (s *CompositeStore) ListTasks(ctx context.Context, filters map[string]interface{}) ([]*internalModels.Task, error) {
	// TODO: Implement
	return []*internalModels.Task{}, nil
}

func (s *CompositeStore) UpdateTask(ctx context.Context, task *internalModels.Task) error {
	// TODO: Implement
	return nil
}

func (s *CompositeStore) GetPendingTasksForHost(ctx context.Context, hostID string) ([]*internalModels.Task, error) {
	// TODO: Implement
	return []*internalModels.Task{}, nil
}

func (s *CompositeStore) GetTasksByExperiment(ctx context.Context, experimentID string) ([]*internalModels.Task, error) {
	// TODO: Implement
	return []*internalModels.Task{}, nil
}
...
// Agent operations (TODO: Implement)
func (s *CompositeStore) UpsertAgent(ctx context.Context, agent *internalModels.AgentStatus) error {
	// TODO: Implement
	return nil
}

func (s *CompositeStore) GetAgent(ctx context.Context, hostID string) (*internalModels.AgentStatus, error) {
	// TODO: Implement
	return nil, fmt.Errorf("not implemented")
}

func (s *CompositeStore) ListAgents(ctx context.Context) ([]*internalModels.AgentStatus, error) {
	// TODO: Implement
	return []*internalModels.AgentStatus{}, nil
}

func (s *CompositeStore) UpdateAgentHeartbeat(ctx context.Context, heartbeat *internalModels.AgentHeartbeat) error {
	// TODO: Implement
	return nil
}
...
// CacheMetric stores a metric in the cache for faster queries
func (s *CompositeStore) CacheMetric(ctx context.Context, hostID string, metric map[string]interface{}) error {
	// TODO: Implement actual metric caching, possibly using Redis or an in-memory cache
