...
import (
	...
	pipelinev1alpha1 "github.com/phoenix/platform/projects/pipeline-operator/api/v1alpha1"
)
...
func (k *KubernetesClient) DeployPipeline(ctx context.Context, deployment *PipelineDeployment) error {
	...
	// TODO: Create ConfigMap with OTel configuration if not already present
...
func (k *KubernetesClient) ListExperimentPipelines(ctx context.Context, experimentID, namespace string) ([]*PipelineStatus, error) {
	...
	if err := k.client.List(ctx, pipelineList, listOptions, labelSelector); err != nil {
